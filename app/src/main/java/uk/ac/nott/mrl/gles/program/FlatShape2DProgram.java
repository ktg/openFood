...
import uk.ac.nott.mrl.gles.shape.Shape2D;
 ...
 */
public class FlatShape2DProgram
{
	...
	public FlatShape2DProgram()
	{
		...
		muColorLoc = GLES20.glGetUniformLocation(programHandle, "uColor");
	...
	public void draw(float[] matrix, Shape2D drawable)
	{
		draw(matrix, drawable.getColour(), drawable.getVertexArray(), 0,
